...
public class ListOfFriends {
    ...
    public ListOfFriends()
    {
        ...
        friendList.add(new Friend("Jimmi Kristensen", "Aakjærsevej 11, 6920 Videbæk", 55.992248, 8.742392, 53834542, "jimmi@live.dk", "https://www.facebook.com/jimmi.kristensen.98", "26011992", "" ));
        friendList.add(new Friend("Jesper Jacobsen", "Buen 1C, 6920 Videbæk", 55.990255, 8.743010, 42560212, "jesperj@live.dk", "https://www.facebook.com/jesper.jacobsen.7315", "021291", "" ));
        friendList.add(new Friend("Lars Schmidt", "Frodesgade 58, 6700 Esbjerg", 55.473689, 8.436949, 53834542, "lars@live.dk", "https://www.facebook.com/xschmidt1", "251094", "" ));
        friendList.add(new Friend("Mads Huus", "Hvirveltoften 11, 6920 Videbæk", 55.994820, 8.736627, 21251164, "mads@live.dk", "https://www.facebook.com/MHuusG", "021193", "" ));
        ...
        friendList.add(new Friend("Søren Vormisto ", "Kongevejen 37, 7430 Ikast", 56.136608, 9.152281, 23461182, "soren@live.dk", "https://www.facebook.com/vormistox", "040294", "" ));
        ...
        friendList.add(new Friend("Kent Pedersen", "Skolegade 60, 6700 Esbjerg", 55.467311, 8.447195, 28262549, "kent@live.dk", "https://www.facebook.com/KentJuulp", "250889", "" ));
        friendList.add(new Friend("Daniel Rasmussen", "Engdraget 4, 6800 Varde", 55.616477, 8.483755, 26294128, "daniel@live.dk", "https://www.facebook.com/daniel.rasmussen.1800", "100892", "" ));
    }
